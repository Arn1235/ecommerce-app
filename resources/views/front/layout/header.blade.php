                    ...
                    <div class="col-lg-12">
                        <div class="logo-search-category-wrapper">
                            <a href="index-2.html" class="logo-area">
                                <img src="{{asset('front/assets/images/logo/logo-01.svg')}}" alt="logo-main" class="logo">
                            </a>
                                ...
                                <div class="btn-border-only cart category-hover-header">
                                    ...
                                    <div class="category-sub-menu card-number-show">
                                        ...
                                        <div class="cart-item-1 border-top">
                                            <div class="img-name">
                                                <div class="thumbanil">
                                                    <img src="{{asset('front/assets/images/shop/cart-1.png')}}" alt="">
                                                </div>
                                                <div class="details">
                                        ...
                                        <div class="cart-item-1">
                                            <div class="img-name">
                                                <div class="thumbanil">
                                                    <img src="{{asset('front/assets/images/shop/05.png')}}" alt="">
                                                </div>
                                                <div class="details">
                                                    <a href="shop-details.html">
                                                        <h5 class="title">Foster Farms Breast Nuggets Shaped Chicken</h5>
                                        ...
                                        <div class="cart-item-1">
                                            <div class="img-name">
                                                <div class="thumbanil">
                                                    <img src="{{asset('front/assets/images/shop/04.png')}}" alt="">
                                                </div>
                                                <div class="details">
                                                    <a href="shop-details.html">
                                                        <h5 class="title">Foster Farms Breast Nuggets Shaped Chicken</h5>
                        ...
                        <div class="nav-and-btn-wrapper">
                            <div class="nav-area-bottom-left-header-four">
                                <div class="category-btn category-hover-header">
                                    <!-- <img class="parent" src="front/assets/images/icons/bar-1.svg" alt="icons"> -->
                                    <span>All Categories</span>
                                    <ul class="category-sub-menu" id="category-active-four">
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/01.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/02.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/03.svg')}}" alt="icons">
                                                <span>Breads &amp; Bakery</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/04.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/05.svg')}}" alt="icons">
                                                <span>Medical Healthcare</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/06.svg')}}" alt="icons">
                                                <span>Breads &amp; Bakery</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/07.svg')}}" alt="icons">
                                        ...
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/08.svg')}}" alt="icons">
                                                <span>Frozen Foods</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/09.svg')}}" alt="icons">
                                                <span>Grocery &amp; Staples</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('front/assets/images/icons/10.svg')}}" alt="icons">
        ...
        <ul class="parent-nav">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4">
                                <a href="shop-grid-sidebar.html" class="feature-add-megamenu-area">
                                    <img src="{{asset('front/assets/images/feature/05.jpg')}}" alt="feature_product">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <li class="parent"><a href="contact.html">Contact</a></li>
                        ...
                        <div class="logo-search-category-wrapper">
                            ...
                            <div class="category-search-wrapper">
                                <div class="category-btn category-hover-header">
                                    <img class="parent" src="{{asset('front/assets/images/icons/bar-1.svg')}}" alt="icons">
                                    <span class="cts">All Categories</span>
                                    <ul class="category-sub-menu">
                                        <li>
                                            <a href="#" class="menu-item">
                                                <img src="{{asset('s/images/icons/01.svg')}}" alt="icons">
                                                <span>Breakfast &amp; Dairy</span>
                                                <i class="fa-regular fa-plus"></i>
                                            </a>
                                        </li>
