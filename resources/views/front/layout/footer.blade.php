                ...
                <div class="col-lg-12">
                    ...
                    <div class="social-and-payment-area-wrapper">
                        ...
                        <div class="payment-access">
                            ...
                            <img src="{{asset('front/assets/images/payment/01.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="copyright-between-1">
                        ...
                        <a href="#" class="playstore-app-area">
                            ...
                            <img src="{{asset('front/assets/images/payment/02.png')}}" alt="">
                            <img src="{{asset('front/assets/images/payment/03.png')}}" alt="">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="product-thumb-area">
                    ...
                    <div class="thumb-wrapper one filterd-items figure">
                        <div class="product-thumb zoom" onmousemove="zoom(event)"
                            style="background-image: url{{asset('(front/assets/images/products/product-details.jpg)')}}"><img
                                src="{{asset('front/assets/images/products/product-details.jpg')}}" alt="product-thumb">
                        </div>
                    </div>
                    <div class="thumb-wrapper two filterd-items hide">
                        <div class="product-thumb zoom" onmousemove="zoom(event)"
                            style="background-image: url{{asset('(front/assets/images/products/product-filt2.jpg)')}}"><img
                                src="{{asset('front/assets/images/products/product-filt2.jpg')}}" alt="product-thumb">
                        </div>
                    </div>
                    <div class="thumb-wrapper three filterd-items hide">
                        <div class="product-thumb zoom" onmousemove="zoom(event)"
                            style="background-image: url{{asset('(front/assets/images/products/product-filt3.jpg)')}}"><img
                                src="{{asset('front/assets/images/products/product-filt3.jpg')}}" alt="product-thumb">
                        </div>
                    </div>
                    <div class="product-thumb-filter-group">
                        <div class="thumb-filter filter-btn active" data-show=".one"><img
                                src="{{asset('front/assets/images/products/product-filt1.jpg')}}" alt="product-thumb-filter"></div>
                        <div class="thumb-filter filter-btn" data-show=".two"><img
                                src="{{asset('front/assets/images/products/product-filt2.jpg')}}" alt="product-thumb-filter"></div>
                        <div class="thumb-filter filter-btn" data-show=".three"><img
                                src="{{asset('front/assets/images/products/product-filt3.jpg')}}" alt="product-thumb-filter"></div>
                    </div>
                </div>
                <div class="contents">
...
<!--================= Preloader End Here =================-->
   ...
   <div class="search-input-area">
    ...
    <!-- plugins js -->
    <script defer src="{{asset('front/assets/js/plugins.js')}}"></script>
...
<!-- Mirrored from html.themewant.com/ekomart/index-four.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Oct 2024 10:35:35 GMT -->
</html>