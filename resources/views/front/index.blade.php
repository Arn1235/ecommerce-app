 ...
 <!-- rts banenr area start -->
    <div class="rts-banner-area rts-section-gap banner-bg_4 bg_image  d-flex align-items-center">
        <div class="transparent-person">
            <img src="front/assets/images/banner/transparent/01.png" alt="banenr">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                ...
                                                                <img src="front/assets/images/category/01.png" alt="category">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/02.png" alt="category">
                                                                <p>Organic Vegetable</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/03.png" alt="category">
                                                                <p>Organic Vegetable</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/04.png" alt="category">
                                                                <p>Organic Vegetable</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/05.png" alt="category">
                                                                <p>Organic Foods</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/06.png" alt="category">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/07.png" alt="category">
                                                                <p>Organic Vegetable</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/08.png" alt="category">
                                                                <p>Organic Vegetable</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/09.png" alt="category">
                                                                <p>Organic Vegetable</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-category-one height-180">
                                                                <a href="{{ url('product-list') }}">
                                                                <img src="front/assets/images/category/10.png" alt="category">
                                                                <p>Organic Vegetable</p>
                                                                <span>299 Items</span>
                                                                </a>
                                                            </div>
                                                ...
                                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                <div class="badge">
                                                                    <span>25% <br> 
                                                                        Off
                                                                    </span>
                                                                ...
                                                                <img src="front/assets/images/grocery/15.jpg" alt="grocery">
                                                            </a>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/16.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                        ...
                                                        <div class="body-content">
                                                            ...
                                                            <a href="{{ url('product-details') }}">
                                                                <h4 class="title">Rias Spicy Paprika Flavour Crips</h4>
                                                            </a>
                                                            <span class="availability">500g Pack</span>
                                                            <div class="price-area">
                                                                <span class="current">$36.00</span>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/17.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/18.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/19.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/20.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/21.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/22.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/23.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/24.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/25.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                                    ...
                                                    <div class="single-shopping-card-one">
                                                        ...
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-details') }}" class="thumbnail-preview">
                                                                ...
                                                                <img src="front/assets/images/grocery/26.jpg" alt="grocery">
                                                            </a>
                                                            <div class="action-share-option">
                                                                <div class="single-action openuptip message-show-action" data-flow="up" title="Add To Wishlist">
                                                                    <i class="fa-light fa-heart"></i>
                                            ...
                                            <div class="row g-4">
                                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                                                    <div class="single-shopping-card-one">
                                                        <!-- iamge and sction area start -->
                                                        <div class="image-and-action-area-wrapper">
                                                            <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                                                <div class="badge">
                                                                    <span>25% <br> 
                                                                        Off
                                                                    </span>
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-shopping-card-one tranding-product">
                                                                <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                                                    <img src="front/assets/images/grocery/08.jpg" alt="grocery">
                                                                </a>
                                                                <div class="body-content">
                                                                    <a href="{{ url('product-list') }}">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-shopping-card-one tranding-product">
                                                                <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                                                    <img src="front/assets/images/grocery/09.jpg" alt="grocery">
                                                                </a>
                                                                <div class="body-content">
                                                                    <a href="{{ url('product-list') }}">
                                                                        <h4 class="title">Pastine Mellin Filid Angelo 100% Di Grano Tenero</h4>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-shopping-card-one tranding-product">
                                                                <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                                                    <img src="front/assets/images/grocery/10.jpg" alt="grocery">
                                                                </a>
                                                                <div class="body-content">
                                                                    <a href="{{ url('product-list') }}">
                                                                        <h4 class="title">Pastine Mellin Filid Angelo 100% Di Grano Tenero</h4>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-shopping-card-one tranding-product">
                                                                <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                                                    <img src="front/assets/images/grocery/11.jpg" alt="grocery">
                                                                </a>
                                                                <div class="body-content">
                                                                    <a href="{{ url('product-list') }}">
                                                                        <h4 class="title">Pastine Mellin Filid Angelo 100% Di Grano Tenero</h4>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-shopping-card-one tranding-product">
                                                                <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                                                    <img src="front/assets/images/grocery/12.jpg" alt="grocery">
                                                                </a>
                                                                <div class="body-content">
                                                                    <a href="{{ url('product-list') }}">
                                                                        <h4 class="title">Pastine Mellin Filid Angelo 100% Di Grano Tenero</h4>
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-shopping-card-one tranding-product">
                                                                <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                                                    <img src="front/assets/images/grocery/13.jpg" alt="grocery">
                                                                </a>
                                                                <div class="body-content">
                                                                    <a href="{{ url('product-list') }}">
                                                                        <h4 class="title">Pastine Mellin Filid Angelo 100% Di Grano Tenero</h4>
                            ...
                            <div class="row g-4">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="single-shopping-card-one tranding-product with-progress">
                                        <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                            <img src="front/assets/images/grocery/27.jpg" alt="grocery">
                                        </a>
                                        <div class="body-content">
                                            <div class="top">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="single-shopping-card-one tranding-product with-progress">
                                        <a href="{{ url('product-list') }}" class="thumbnail-preview">
                                            <img src="front/assets/images/grocery/28.jpg" alt="grocery">
                                        </a>
                                        <div class="body-content">
                                            <div class="top">
                                                <div class="stars-area">
            ...
            <div class="row g-4">
                <div class="col-lg-3">
                    ...
                    <div class="feature-product-list-wrapper">
                        ...
                        <div class="single-product-list">
                            <a href="{{ url('product-list') }}" class="thumbnail">
                                <img src="front/assets/images/grocery/01.jpg" alt="product">
                            </a>
                            <div class="body-content">
                                <div class="top">
                                    <div class="stars-area">
                        ...
                        <div class="single-product-list">
                            <a href="{{ url('product-list') }}" class="thumbnail">
                                <img src="front/assets/images/grocery/02.jpg" alt="product">
                            </a>
                            <div class="body-content">
                                <div class="top">
                                    <div class="stars-area">
                        ...
                        <div class="single-product-list">
                            <a href="{{ url('product-list') }}" class="thumbnail">
                                <img src="front/assets/images/grocery/03.jpg" alt="product">
                            </a>
                            <div class="body-content">
                                <div class="top">
                                    <div class="stars-area">
                        ...
                        <div class="single-product-list">
                            <a href="{{ url('product-list') }}" class="thumbnail">
                                <img src="front/assets/images/grocery/04.jpg" alt="product">
                            </a>
                            <div class="body-content">
                                <div class="top">
                                    <div class="stars-area">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="feature-product-list-wrapper">
                        ...
                        <div class="single-product-list">
                            <a href="{{ url('product-list') }}" class="thumbnail">
                                <img src="front/assets/images/grocery/05.jpg" alt="product">
                            </a>
                            <div class="body-content">
                                <div class="top">
                                    <div class="stars-area">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="feature-product-list-wrapper">
                        ...
                        <div class="single-product-list">
                            <a href="{{ url('product-list') }}" class="thumbnail">
                                <img src="front/assets/images/grocery/06.jpg" alt="product">
                            </a>
                            <div class="body-content">
                                <div class="top">
                                    <div class="stars-area">
                ...
                <div class="col-lg-3">
                    <div class="add-area-start-feature">
                        <div class="thumbnail">
                            <img src="front/assets/images/add/01.jpg" alt="add_area">
                        </div>
                        <div class="inner-add-content">
                            <div class="tag">Weekend Discount</div>
                            <h2 class="title">Discover Real organic
                                                ...
                                                <div class="swiper mySwiper-category-1 swiper-data" data-swiper='{
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-blog-area-start">
                                                                <a href="blog-details.html" class="thumbnail">
                                                                    <img src="front/assets/images/blog/01.jpg" alt="blog-area">
                                                                </a>
                                                                <div class="blog-body">
                                                                    <div class="top-area">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-blog-area-start">
                                                                <a href="blog-details.html" class="thumbnail">
                                                                    <img src="front/assets/images/blog/02.jpg" alt="blog-area">
                                                                </a>
                                                                <div class="blog-body">
                                                                    <div class="top-area">
                                                                        <div class="single-meta">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-blog-area-start">
                                                                <a href="blog-details.html" class="thumbnail">
                                                                    <img src="front/assets/images/blog/03.jpg" alt="blog-area">
                                                                </a>
                                                                <div class="blog-body">
                                                                    <div class="top-area">
                                                                        <div class="single-meta">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="single-blog-area-start">
                                                                <a href="blog-details.html" class="thumbnail">
                                                                    <img src="front/assets/images/blog/04.jpg" alt="blog-area">
                                                                </a>
                                                                <div class="blog-body">
                                                                    <div class="top-area">
                                                                        <div class="single-meta">
